...
import hexdoc_hex_circles

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class Hex_circlesPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return Hex_circlesModPlugin(branch=branch)


class Hex_circlesModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hex_circles"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hex_circles, "_templates"
