...
import net.hex_circles.client.LookClient;
...
public class SetLookPitchS2CMsg {
    ...
    /**
     * Constructor for recreation on the client from a {@link PacketByteBuf} onto which it was encoded
     * on the server using {@link #encode(PacketByteBuf)}.
     * @param buf Buffer onto which the message was encoded
     */
    public SetLookPitchS2CMsg(PacketByteBuf buf) {
